...
<meta http-equiv="Cache-Control" content="no-siteapp" />
        ...
        <link href="${baseUrl}/assets/css/codemirror.css" rel="stylesheet">
        <link rel="stylesheet" href="${baseUrl}/assets/css/ace.min.css" />
        <link rel="stylesheet" href="${baseUrl}/font/css/font-awesome.min.css" />
        <!--[if lte IE 8]>
		  <link rel="stylesheet" href="assets/css/ace-ie.min.css" />
		<![endif]-->
		<script src="${baseUrl}/js/jquery-1.9.1.min.js"></script>
        <script src="${baseUrl}/assets/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="${baseUrl}/Widget/Validform/5.3.2/Validform.min.js"></script>
		<script src="${baseUrl}/assets/js/typeahead-bs2.min.js"></script>
		<script src="${baseUrl}/assets/js/jquery.dataTables.min.js"></script>
		<script src="${baseUrl}/assets/js/jquery.dataTables.bootstrap.js"></script>
        <script src="${baseUrl}/assets/layer/layer.js" type="text/javascript" ></script>
		<script src="${baseUrl}/js/lrtk.js" type="text/javascript" ></script>
         <script src="${baseUrl}/assets/layer/layer.js" type="text/javascript"></script>
        <script src="${baseUrl}/assets/laydate/laydate.js" type="text/javascript"></script>
<title>管理员</title>
</head>
